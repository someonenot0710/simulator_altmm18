...
y2 = [p_total_fix, p_total_wifi, p_total_four];
x2=[12,10,8];
error2 = [p_std_fix,p_std_wifi,p_std_four];

errorbar(x1,y1,error1,'-', 'linestyle', 'none', 'LineWidth', 2, 'LineStyle','-');
hold on
errorbar(x2,y2,error2, 'linestyle', 'none', 'LineWidth', 2, 'LineStyle','-.');
